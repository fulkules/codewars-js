...
// one of two types of sex chromosomes. They are either X or Y. The female gametes or eggs
...
//
// If the sperm contains the X chromosome, return "Congratulations! You're going to have
// a daughter."; If the sperm contains the Y chromosome,
// return "Congratulations! You're going to have a son.";



function chromosomeCheck(sperm) {
    let sex = sperm === 'XX' ? 'daughter' : 'son';
