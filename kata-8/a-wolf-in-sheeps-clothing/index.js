...
// Wolves have been reintroduced to Great Britain. You are a sheep farmer, and are now plagued
// by wolves which pretend to be sheep. Fortunately, you are good at spotting them.
//
...
function warnTheSheep(queue){
    ...
    let idx = queue.reverse().indexOf('wolf');
    return `Oi! Sheep number ${idx}! You are about to be eaten by a wolf!`;
}

// voted best practice -- arguable
// function warnTheSheep(queue) {
