...
//     (always a string), and returns a greeting - if you have it in
//     your database. It should default to English if the language
...
//   return language in db ? welcomes[language] : welcomes.english;
// };
