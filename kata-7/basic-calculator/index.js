...
// of the corresponding mathematical function on the two numbers. If the string
// is not one of the specified characters, the function should return null
...
// fn(num, string, num) => num
// formula is different depending on operation
// switch case based on formulas
...
// voted best practice - although i disagree
// function calculate(num1, operation, num2) {
//   const ops = {
