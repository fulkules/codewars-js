...
for 0.90 times the ticket price, then for each additional
ticket he pays 0.90 times the price paid for the previous ticket.
...
const movie = (card, ticket, perc) => {
    let n = 1;
    while(systemA(ticket, n) <= systemB(card, ticket, perc, n)){
        n++
    }
    return n;
};
